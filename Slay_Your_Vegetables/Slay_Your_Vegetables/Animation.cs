...
public abstract class Animation 
{
    ...
    private float Frametime; // frame arası planlanan süre
    private float timer; // geçen süre
    protected int loop;
    ...
    public virtual void Update(GameTime gameTime)
    {
       ...
       if (timer>= Frametime) // geçen süre belirlenen frame süresinden büyükse frame değişir (fps ile alakalı her zaman eşit olmayabilir)
        {
            timer=0f;
            CurrentFrame++;
